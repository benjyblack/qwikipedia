...
/***/ function(module, exports, __webpack_require__) {
	...
	var BASE_URL = 'https://wikipedia.org';
	var TOOLTIP_HTML = '<div data-id="qwiki-pop" class="popover" role="tooltip">' + '<div class="arrow"></div>' + '<h3 class="popover-title"></h3>' + '<div class="popover-content"></div>' + '</div>';

	var onReady = function onReady() {
	  __webpack_require__(10);

	  var allLinkTags = (0, _jquery2.default)('a');
	  var interestingLinkTags = jqfy(_lodash2.default.filter(allLinkTags, isLinkTagInteresting));

	  _lodash2.default.invokeMap(interestingLinkTags, 'attr', 'data-toggle', 'popover');
	  _lodash2.default.invokeMap(interestingLinkTags, 'attr', 'data-placement', 'bottom');
	  _lodash2.default.invokeMap(interestingLinkTags, 'popover', {
	    trigger: 'hover',
	...
	var jqfy = _lodash2.default.partialRight(_lodash2.default.map, _jquery2.default);

	var isLinkTagInteresting = function isLinkTagInteresting(targetUrl) {
	  var linkTagURL = targetUrl.getAttribute('href');
	  return linkTagURL && linkTagURL.match('/wiki/') && !linkTagURL.match(document.URL + '#') && !linkTagURL.match('/wiki/Wikipedia:') && !linkTagURL.match('/wiki/File:');
	};

	var getTooltipContent = function getTooltipContent() {
	  var FIRST_PARAGRAPH_SELECTOR = '#mw-content-text p:first-of-type';
	  var link = BASE_URL + this.getAttribute('href');

	  (0, _isomorphicFetch2.default)(link).then(function (response) {
	    return response.text();
	  }).then(function (html) {
	    var parsedHTML = _jquery2.default.parseHTML(html);
	    var firstParagraph = (0, _jquery2.default)(parsedHTML).find(FIRST_PARAGRAPH_SELECTOR);
	    var firstParagraphText = firstParagraph.text();

	    (0, _jquery2.default)('[data-id="qwiki-pop"] .popover-content').text(firstParagraphText);
	  });
...
/***/ function(module, exports) {
	...
	/*!
	 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=44dc5d6e075cbabcd7ca)
	 * Config saved to config.json and https://gist.github.com/44dc5d6e075cbabcd7ca
	 */
