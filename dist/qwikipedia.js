...
/***/ function(module, exports, __webpack_require__) {
	...
	var TIMER_LENGTH = 200;

	var onReady = function onReady() {
	  var allLinkTags = $('a');
	  var interestingLinkTags = _.filter(allLinkTags, isLinkTagInteresting);
	  debugger;
	...
	var getInterestingLinkTags = function getInterestingLinkTags() {
	  return $('a').filter(function (index, linkTag) {
	...
	function x() {
	  ...
	  var getInformation = function getInformation(url, callback) {
	  ...
	  var parsePage = function parsePage(html) {
	    ...
	    $(this).hover(function (e) {
	      ...
	      showTimer = setTimeout(function () {
	        ...
	        getInformation(_this.getAttribute('href'), function (text) {
	          ...
	          var o = $(_this).offset();
	          var oH = tooltipNode.offsetHeight;
	          ...
	          if (checkFlip) {
	            ...
	            } else if (tooltipNode.className === 'qwiki-referencetooltip RTflipped') {
	              // cancel previous
